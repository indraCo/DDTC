        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1 }}>
                    ...
                    >
                        <View style={{ flex: 1, backgroundColor: 'white', height: height - 80}}>
                          <View style={{ flex: 3, paddingHorizontal: 20, paddingVertical: 20, justifyContent: 'center', alignItems: 'center',}}>
                          ...
                          <View style={{ flex: 2, paddingHorizontal: 20, paddingVertical: 20, justifyContent: 'center', alignItems: 'center',}}>
